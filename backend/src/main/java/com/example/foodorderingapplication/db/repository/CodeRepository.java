...
public interface CodeRepository extends JpaRepository<Code,Long> {
    ...
    @Query("select new com.example.foodorderingapplication.dto.CodeDto(c.id,r.id,c.name,c.value,c.expirationDate) from Code c join c.restaurant r where r.id = :id")
